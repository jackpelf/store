...
void All(SqList *L)
{
	...
	*t=*L;
	...
	printf("		      正序			逆序\n");
	printf("BubbleSort冒泡     %10lld    %10lld    %10lld    %10lld    \n", mem[i][0], mem[i][1], mem[i][2], mem[i][3]);
	i++;                                                                                                              
	printf("QuickSort快排      %10lld    %10lld    %10lld    %10lld    \n", mem[i][0], mem[i][1], mem[i][2], mem[i][3]); 
	i++;                                                                                                              
	printf("InsertSort直接插入 %10lld    %10lld    %10lld    %10lld    \n", mem[i][0], mem[i][1], mem[i][2], mem[i][3]); 
	i++;                                                                                                              
	printf("SelectSort选择     %10lld    %10lld    %10lld    %10lld    \n", mem[i][0], mem[i][1], mem[i][2], mem[i][3]); 
	i++;                                                                                                              
	printf("ShellSort希尔      %10lld    %10lld    %10lld    %10lld    \n", mem[i][0], mem[i][1], mem[i][2], mem[i][3]); 
	i++;                                                                                                              
	printf("HeapSort堆         %10lld    %10lld    %10lld    %10lld    \n", mem[i][0], mem[i][1], mem[i][2], mem[i][3]); 
	i++;                                                                                                              
	printf("MergeSort归并      %10lld    %10lld    %10lld    %10lld    \n", mem[i][0], mem[i][1], mem[i][2], mem[i][3]); 
	i++;                                                                                                              
	printf("BInsertSort折半插入%10lld    %10lld    %10lld    %10lld    \n", mem[i][0], mem[i][1], mem[i][2], mem[i][3]); 
	i++;                                                                                                              
	printf("Path2Insert2路插入 %10lld    %10lld    %10lld    %10lld    \n", mem[i][0], mem[i][1], mem[i][2], mem[i][3]); 
	i++;                                                                                                              
	printf(".RadixSort基数     %10lld    %10lld    %10lld    %10lld    \n", mem[i][0], mem[i][1], mem[i][2], mem[i][3]); 
	i++;             
	is_all = 0;                   
}                                            
